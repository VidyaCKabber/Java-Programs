...
public class Source {
    public static void main(String[] args) {
        ...
        while(!bookStack.isEmpty()){
            ...
            int pageRead = Math.min(currentBook.getPages(), 100);
            currentBook = new Book(currentBook.getTitle(), currentBook.getPages() - 100);
            System.out.println("Reading 100 pages of "+ currentBook.getTitle());
